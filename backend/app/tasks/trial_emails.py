...
MILESTONES = [
    ("day_2",  2,  3,  "Tudo a correr bem? — pieta.care",                trial_day2_html),
    ("day_7",  7,  8,  "Como tem sido a experiência? — pieta.care",      trial_day7_html),
    ("day_13", 13, 14, "Faltam 24 horas no seu trial — pieta.care",      trial_day13_html),
]
