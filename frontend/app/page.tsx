      ...
      <section style={{ padding: '100px 24px', background: '#fff' }}>
        <div style={{ maxWidth: 1000, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(220px, 1fr))', gap: 20 }}>
            {FEATURES.map(f => (
              <div key={f.title} style={{ background: '#F2F5F3', borderRadius: 16, padding: '24px 20px', border: '1px solid #DDE8E2', transition: 'transform 0.15s' }}>
      ...
      <section id="precos" style={{ padding: '100px 24px', background: '#F2F5F3' }}>
        <div style={{ maxWidth: 1000, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 60 }}>
            ...
            <h2 style={{ fontSize: 'clamp(28px, 4vw, 44px)', fontWeight: 900, letterSpacing: '-0.02em' }}>Simple e transparente</h2>
